...
As mentioned in my previous post I have taken too long to initiate on German grammar, as I thought it was not as important. I wasn't aware that the german articles can switch gender according to case(the articles die become der in dative and genitiv!) and now I ended up learning several words as masculine when in reality they are feminine.<br>
It is indeed a common problem among german learners, as the plurals in german do not obey any rule, and the genders are so important for the formation of cases (dative, genitiv, etc.). As the only previous deck I could find with this content carried several mistakes, I decided to implement my own.
<br>
...
<br>
Since they came from an automatic parsing the deck is expected to contain a few mistakes. I have corrected manually the ones I could find, But I count on German learning community to help me check the rest of the deck. Please email me if you find any errors so I can update the deck right away. <br>
...
I used python to parse the flashcards and BeautifulSoup to scrape the information about the plurals, taken from this website: [Verbformen](https://www.verbformen.pt/declinacao/substantivos/Kenntnis.htm)<br>
